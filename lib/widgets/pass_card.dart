...
class _PassCardState extends State<PassCard> {
          ...
          children: [
            ...
            Row(
              children: [
                ...
                if (_currentPass.paymentRefId != "TXN-AGT") ...[
                  // show website icon
                  Row(
                    children: [
                      SizedBox(width: 4),
  ...
  Future<void> _updatePaymentStatus(bool isPaid) async {
    ...
    try {
      final response =
          isPaid
              ? await _passRepository.changeToPaid(_currentPass.sId!)
              : await _passRepository.changeToUnpaid(_currentPass.sId!);
  ...
  bool _isPaymentDone() {
    ...
    return _currentPass.isAmountPaid == true;
  }
